...
pxtnERR pxtnWoice::Tone_Ready_sample( const pxtnPulse_NoiseBuilder *ptn_bldr, int32_t ch, int32_t sps )
{
	pxtnERR            res   = pxtnERR_VOID;
...
pxtnERR pxtnWoice::Tone_Ready( const pxtnPulse_NoiseBuilder *ptn_bldr, int32_t ch, int32_t sps )
{
	pxtnERR res = pxtnERR_VOID;
	res = Tone_Ready_sample  ( ptn_bldr, ch, sps ); if( res != pxtnOK ) return res;
